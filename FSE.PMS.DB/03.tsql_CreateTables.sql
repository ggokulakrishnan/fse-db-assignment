...
-- Creating primary key on [ParentTaskID] in table 'ParentTasks'
...
-- Creating foreign key on [ProjectID] in table 'Users'
ALTER TABLE [dbo].[Users]
...
-- Creating foreign key on [TaskID] in table 'Users'
ALTER TABLE [dbo].[Users]
